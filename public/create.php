...
if (isset($_POST['adduser'])) {
  try  {
    ...
    //mkdir('../storage/app/Images/'.$_POST['email'].'/Top', 0777, true);
    //mkdir('../storage/app/Images/'.$_POST['email'].'/Bottom', 0777, true);
    mkdir('Images/'.$_POST['email'].'/Top', 0777, true);
    mkdir('Images/'.$_POST['email'].'/Bottom', 0777, true);
